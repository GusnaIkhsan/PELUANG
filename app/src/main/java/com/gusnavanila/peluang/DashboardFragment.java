...
//        Dekorasi
        DividerItemDecoration horizontalDeco = new DividerItemDecoration(_recycleView2.getContext(),DividerItemDecoration.VERTICAL);
        Drawable horizontalDivider = ContextCompat.getDrawable(getActivity(),R.drawable.horizontal_divider);
        horizontalDeco.setDrawable(horizontalDivider);
        _recycleView2.addItemDecoration(horizontalDeco);
